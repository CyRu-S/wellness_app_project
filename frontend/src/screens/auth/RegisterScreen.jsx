...
export default function RegisterScreen({ navigation }) {
  ...
  const submit = async () => {
    const result = await dispatch(register(profile));
    if (register.fulfilled.match(result)) navigation.navigate('VerifyEmail', { email: email.trim().toLowerCase() });
  };
          ...
          <View style={styles.sheet}>
            ...
            <StaggeredView delay={150} style={styles.sectionCard}>
              ...
              <View style={styles.fields}>
                ...
                <AuthField label="Password" icon="lock-closed-outline" placeholder="At least 8 characters" value={password} onChangeText={setPassword} secureTextEntry passwordToggle textContentType="newPassword" />
              </View>
            </StaggeredView>
