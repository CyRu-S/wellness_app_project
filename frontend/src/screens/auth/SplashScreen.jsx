...
export default function SplashScreen({ navigation }) {
  ...
  return (
    <LinearGradient colors={[colors.ink, colors.tealDark]} style={styles.page}>
      <AmbientBackground />
      <StaggeredView delay={40} style={styles.edition}><Text style={styles.editionText}>PERSONAL CARE · MADE FOR YOU</Text></StaggeredView>
      <View style={styles.hero}>
        <AnimatedLogo size={190} halo />
        <StaggeredView delay={260} style={styles.copy}><Text style={styles.name}>Mr_Care</Text><Text style={styles.nameAccent}>WELLNESS, PERSONALISED</Text><View style={styles.line} /><Text style={styles.note}>NOURISH · MOVE · THRIVE</Text></StaggeredView>
      </View>
...
const styles = StyleSheet.create({
  ...
  name: { color: colors.white, fontFamily: fonts.semibold, fontSize: 43, lineHeight: 48, letterSpacing: -1.2 }, nameAccent: { color: colors.accent, fontFamily: fonts.medium, fontSize: 10, letterSpacing: 2.4, marginTop: 4 },
