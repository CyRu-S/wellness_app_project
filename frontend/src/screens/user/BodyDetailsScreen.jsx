...
const styles = StyleSheet.create({
  ...
  availability: { minHeight: 76, flexDirection: 'row', alignItems: 'center', gap: 12, backgroundColor: colors.accentSoft, borderRadius: radius.md, paddingHorizontal: 15, marginTop: 23 }, availabilityLocked: { backgroundColor: colors.mist }, availabilityIcon: { width: 39, height: 39, borderRadius: 13, backgroundColor: colors.surface, alignItems: 'center', justifyContent: 'center' }, availabilityCopy: { flex: 1 }, availabilityLabel: { ...type.label, color: colors.tealMid, fontSize: 7 }, availabilityValue: { color: colors.ink, fontFamily: fonts.medium, fontSize: 12, lineHeight: 16, marginTop: 3 },
  form: { marginTop: 24 }, field: { paddingVertical: 14, borderBottomWidth: StyleSheet.hairlineWidth, borderColor: colors.line }, fieldLabel: { ...type.label, color: colors.muted, fontSize: 8 }, inputRow: { flexDirection: 'row', alignItems: 'center' }, input: { flex: 1, color: colors.ink, fontFamily: fonts.semibold, fontSize: 25, paddingVertical: 5 }, inputLocked: { color: colors.muted }, unit: { color: colors.muted, fontFamily: fonts.medium, fontSize: 13 },
  save: { minHeight: 54, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, backgroundColor: colors.tealMid, borderRadius: radius.md, marginTop: 25 }, saveDisabled: { backgroundColor: colors.muted }, saveText: { color: colors.white, fontFamily: fonts.semibold, fontSize: 13 }, privacy: { flexDirection: 'row', alignItems: 'center', gap: 8, marginTop: 17, paddingHorizontal: 4 }, privacyText: { flex: 1, color: colors.muted, fontFamily: fonts.regular, fontSize: 10, lineHeight: 15 },
});
