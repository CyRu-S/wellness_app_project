...
const styles = StyleSheet.create({
  ...
  controls: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 22, marginTop: 22 }, secondaryControl: { width: 47, height: 47, borderRadius: 24, backgroundColor: colors.mist, alignItems: 'center', justifyContent: 'center' }, disabled: { opacity: 0.35 }, play: { width: 66, height: 66, borderRadius: 33, backgroundColor: colors.tealMid, alignItems: 'center', justifyContent: 'center', ...shadows.soft }, help: { color: colors.muted, fontFamily: fonts.regular, fontSize: 10, textAlign: 'center', marginTop: 13 },
  saved: { flexDirection: 'row', alignItems: 'center', gap: 11, backgroundColor: colors.accentSoft, borderRadius: radius.md, padding: 14, marginTop: 15 }, savedIcon: { width: 30, height: 30, borderRadius: 15, backgroundColor: colors.tealMid, alignItems: 'center', justifyContent: 'center' }, savedCopy: { flex: 1 }, savedTitle: { color: colors.ink, fontFamily: fonts.semibold, fontSize: 12 }, savedMeta: { color: colors.muted, fontFamily: fonts.regular, fontSize: 9, marginTop: 3 },
  history: { marginTop: 28 }, historyHead: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingBottom: 6 }, historyTitle: { ...type.label, color: colors.muted, fontSize: 8 }, historyCount: { color: colors.tealMid, fontFamily: fonts.medium, fontSize: 10 }, historyRow: { minHeight: 66, flexDirection: 'row', alignItems: 'center', gap: 11, borderBottomWidth: StyleSheet.hairlineWidth, borderColor: colors.line }, historyIcon: { width: 38, height: 38, borderRadius: 13, backgroundColor: colors.mist, alignItems: 'center', justifyContent: 'center' }, historyCopy: { flex: 1 }, historyName: { color: colors.ink, fontFamily: fonts.semibold, fontSize: 13 }, historyMeta: { color: colors.muted, fontFamily: fonts.regular, fontSize: 9, marginTop: 3 }, historyCalories: { color: colors.tealMid, fontFamily: fonts.semibold, fontSize: 11, textAlign: 'right' }, historyMinutes: { color: colors.muted, fontFamily: fonts.regular, fontSize: 9, textAlign: 'right', marginTop: 2 },
});
