...
const styles = StyleSheet.create({
  head: { marginTop: 20, gap: 8 }, kicker: { ...type.label, color: colors.tealMid }, title: { ...type.display, color: colors.ink }, body: { ...type.body, color: colors.muted, maxWidth: 340 },
  progressBlock: { marginVertical: 27 }, progressMeta: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }, progressLabel: { ...type.label, color: colors.muted }, progressValue: { color: colors.tealDark, fontFamily: fonts.semibold, fontSize: 13 }, progress: { height: 7, borderRadius: 4, backgroundColor: colors.line, marginTop: 10, overflow: 'hidden' }, progressFill: { height: 7, backgroundColor: colors.accent, borderRadius: 4 },
