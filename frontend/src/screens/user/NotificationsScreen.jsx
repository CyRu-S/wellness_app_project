...
const styles = StyleSheet.create({ kicker: { ...type.label, color: colors.moss, marginTop: 20 }, title: { ...type.display, color: colors.ink, marginTop: 5 }, list: { marginTop: 22 }, item: { flexDirection: 'row', gap: 12, paddingVertical: 20, borderBottomWidth: StyleSheet.hairlineWidth, borderColor: colors.line }, dot: { width: 8, height: 8, borderRadius: 4, backgroundColor: colors.accent, marginTop: 6 }, read: { backgroundColor: colors.line }, copy: { flex: 1 }, itemTitle: { color: colors.ink, fontFamily: fonts.semibold, fontSize: 16 }, body: { color: colors.muted, fontFamily: fonts.regular, lineHeight: 20, marginTop: 5 }, time: { ...type.label, color: colors.muted, fontSize: 9 } });
