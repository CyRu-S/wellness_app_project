...
const styles = StyleSheet.create({
  ...
  summary: { minHeight: 190, backgroundColor: colors.ink, borderRadius: radius.lg, marginTop: 24, padding: 21, overflow: 'hidden' }, summaryTop: { flexDirection: 'row', justifyContent: 'space-between' }, summaryLabel: { ...type.label, color: '#A9D6D4', fontSize: 11 }, summaryTitle: { color: colors.white, fontFamily: fonts.semibold, fontSize: 22, marginTop: 5 }, coach: { color: '#B8D5D5', fontFamily: fonts.medium, fontSize: 12, marginTop: 4 }, count: { color: colors.accent, fontFamily: fonts.bold, fontSize: 29 }, progress: { height: 6, borderRadius: 3, backgroundColor: 'rgba(255,255,255,0.12)', marginTop: 21, overflow: 'hidden' }, progressFill: { height: 6, borderRadius: 3, backgroundColor: colors.accent }, summaryFoot: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginTop: 17 }, summaryMeta: { color: '#BED9D9', fontFamily: fonts.medium, fontSize: 12 }, logButton: { minHeight: 42, flexDirection: 'row', alignItems: 'center', gap: 5, backgroundColor: colors.accent, borderRadius: radius.pill, paddingHorizontal: 14 }, logButtonText: { color: colors.ink, fontFamily: fonts.semibold, fontSize: 12 },
