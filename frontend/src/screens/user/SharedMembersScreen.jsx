...
const styles = StyleSheet.create({
  ...
  liveText: { ...type.label, color: colors.muted, fontSize: 10 },
  ...
  memberMeta: { color: colors.muted, fontFamily: fonts.medium, fontSize: 12, marginTop: 4 },
  ...
  progressLabel: { ...type.label, color: colors.muted, fontSize: 10 },
  progressValue: { color: colors.tealDark, fontFamily: fonts.semibold, fontSize: 12 },
  ...
  signalLabel: { color: colors.muted, fontFamily: fonts.semibold, fontSize: 10, lineHeight: 13, letterSpacing: 0.6, marginTop: 1 },
  ...
  privacyText: { flex: 1, color: colors.inkSoft, fontFamily: fonts.medium, fontSize: 12, lineHeight: 18 },
