...
const styles = StyleSheet.create({
  ...
  topMeta: { color: '#9EC4BF', fontFamily: fonts.regular, fontSize: 9, marginTop: 3 },
  ...
  captionLabel: { ...type.label, color: colors.accent, fontSize: 7 },
  captionTitle: { color: colors.white, fontFamily: fonts.semibold, fontSize: 22, lineHeight: 28, marginTop: 5 },
  captionMeta: { color: '#A8C9C5', fontFamily: fonts.regular, fontSize: 10, lineHeight: 16, marginTop: 5 },
  ...
  nutritionLabel: { ...type.label, color: '#8CB4AF', fontSize: 6, marginTop: 2 },
  ...
  privateText: { ...type.label, color: '#B9D8D3', fontSize: 6 },
