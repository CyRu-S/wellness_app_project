...
const styles = StyleSheet.create({ kicker: { ...type.label, color: colors.moss, marginTop: 20 }, title: { ...type.display, color: colors.ink, marginTop: 5 }, meta: { color: colors.muted, fontFamily: fonts.regular, marginTop: 5 }, summary: { backgroundColor: colors.ink, borderRadius: radius.lg, padding: 24, marginVertical: 28 }, summaryLabel: { ...type.label, color: '#AAC0B4' }, summaryTitle: { color: colors.white, fontFamily: fonts.semibold, fontSize: 25, marginTop: 7 }, summaryText: { color: colors.accent, fontFamily: fonts.medium, marginTop: 8 }, row: { flexDirection: 'row', justifyContent: 'space-between', paddingVertical: 18, borderBottomWidth: StyleSheet.hairlineWidth, borderColor: colors.line }, rowLabel: { color: colors.muted, fontFamily: fonts.regular }, value: { color: colors.ink, fontFamily: fonts.semibold }, actions: { gap: 12, marginTop: 28 } });
