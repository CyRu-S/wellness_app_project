...
const styles = StyleSheet.create({
  ...
  timeBlock: { width: 78, alignSelf: 'stretch', justifyContent: 'center', paddingLeft: 7 }, compactTimeBlock: { width: 72, paddingLeft: 5 }, time: { color: colors.ink, fontFamily: fonts.semibold, fontSize: 14, lineHeight: 20 }, type: { ...type.label, color: colors.muted, fontSize: 10, letterSpacing: 0.8, marginTop: 5 }, copy: { flex: 1, minWidth: 0, justifyContent: 'center', paddingHorizontal: 7 }, name: { color: colors.ink, fontFamily: fonts.semibold, fontSize: 16, lineHeight: 22 }, status: { color: colors.muted, fontFamily: fonts.medium, fontSize: 12, lineHeight: 18, marginTop: 6 }, overdue: { color: colors.danger, fontFamily: fonts.semibold },
